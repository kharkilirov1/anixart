...
public final class C6852x18164156 extends Lambda implements Function1<Throwable, Throwable> {

    /* renamed from: b */
    public final /* synthetic */ Constructor f68257b;
    ...
    public Throwable invoke(Throwable th) {
        ...
        Throwable th2 = th;
        try {
            newInstance = this.f68257b.newInstance(new Object[0]);
        } catch (Throwable th3) {
