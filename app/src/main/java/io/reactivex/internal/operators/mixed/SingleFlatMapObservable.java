...
public final class SingleFlatMapObservable<T, R> extends Observable<R> {
    ...
    public static final class FlatMapObserver<T, R> extends AtomicReference<Disposable> implements Observer<R>, SingleObserver<T>, Disposable {
        ...
        /* renamed from: b */
        public final Observer<? super R> f61335b;

        /* renamed from: c */
        public final Function<? super T, ? extends ObservableSource<? extends R>> f61336c = null;

        public FlatMapObserver(Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function) {
            this.f61335b = observer;
        }
        ...
        public void onComplete() {
            this.f61335b.onComplete();
        }

        @Override // io.reactivex.Observer
        public void onError(Throwable th) {
            this.f61335b.onError(th);
        }

        @Override // io.reactivex.Observer
        public void onNext(R r) {
            this.f61335b.onNext(r);
        }

        @Override // io.reactivex.SingleObserver
        public void onSuccess(T t) {
            try {
                ObservableSource<? extends R> apply = this.f61336c.apply(t);
