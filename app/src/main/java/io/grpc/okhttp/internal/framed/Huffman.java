...
class Huffman {
    ...
    public Huffman() {
        ...
        while (true) {
            ...
            Node node2 = this.f59474a;
            while (b > 8) {
                b = (byte) (b - 8);
                int i4 = (i3 >>> b) & KotlinVersion.MAX_COMPONENT_VALUE;
                Node[] nodeArr = node2.f59475a;
                if (nodeArr == null) {
