...
final class zzsl extends zzut {
    ...
    /* renamed from: r */
    public final EmailAuthCredential f16804r;

    public zzsl(EmailAuthCredential emailAuthCredential) {
        super(2);
        this.f16804r = emailAuthCredential;
    }
    ...
    public final void mo9353a(TaskCompletionSource taskCompletionSource, zztt zzttVar) {
        ...
        EmailAuthCredential emailAuthCredential = this.f16804r;
        FirebaseUser firebaseUser = this.f16864d;
        Objects.requireNonNull(emailAuthCredential);
        emailAuthCredential.f22303e = firebaseUser.mo12247f1();
        emailAuthCredential.f22304f = true;
        zzttVar.m9395f(new zzpk(emailAuthCredential), this.f16862b);
    }
