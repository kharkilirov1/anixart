...
public final class zztu {
    ...
    /* renamed from: a */
    @VisibleForTesting
    public static final SparseArray f16824a;
    ...
    */
    public static com.google.firebase.FirebaseException m9397a(com.google.android.gms.common.api.Status r4) {
        /*
            Method dump skipped, instructions count: 452
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p041firebaseauthapi.zztu.m9397a(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }

    /* renamed from: b */
    public static String m9398b(int i2) {
        Pair pair = (Pair) f16824a.get(i2);
        return pair != null ? (String) pair.first : "INTERNAL_ERROR";
    }

    /* renamed from: c */
    public static String m9399c(String str, Status status) {
        return TextUtils.isEmpty(status.f15381d) ? str : String.format(String.valueOf(str).concat(" [ %s ]"), status.f15381d);
    }
}
