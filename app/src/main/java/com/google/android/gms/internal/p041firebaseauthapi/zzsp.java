...
final class zzsp extends zzut {
    ...
    /* renamed from: r */
    public final zzpk f16806r;

    public zzsp(EmailAuthCredential emailAuthCredential) {
        super(2);
        Preconditions.m8132g(emailAuthCredential, "credential cannot be null or empty");
        this.f16806r = new zzpk(emailAuthCredential);
    }
    ...
    public final void mo9353a(TaskCompletionSource taskCompletionSource, zztt zzttVar) {
        ...
        zzttVar.m9395f(this.f16806r, this.f16862b);
    }
