...
final class zztc extends zzut {
    ...
    /* renamed from: r */
    public final zzpk f16813r;

    public zztc(EmailAuthCredential emailAuthCredential) {
        super(2);
        Preconditions.m8132g(emailAuthCredential, "credential cannot be null");
        this.f16813r = new zzpk(emailAuthCredential);
    }
    ...
    public final void mo9353a(TaskCompletionSource taskCompletionSource, zztt zzttVar) {
        ...
        zzttVar.m9395f(this.f16813r, this.f16862b);
    }
