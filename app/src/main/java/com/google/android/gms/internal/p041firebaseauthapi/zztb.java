...
final class zztb extends zzut {
    ...
    /* renamed from: r */
    @NonNull
    public final zzpi f16812r;

    public zztb(String str, String str2, @Nullable String str3) {
        super(2);
        Preconditions.m8130e(str, "email cannot be null or empty");
        Preconditions.m8130e(str2, "password cannot be null or empty");
        this.f16812r = new zzpi(str, str2, str3);
    }
    ...
    public final void mo9353a(TaskCompletionSource taskCompletionSource, zztt zzttVar) {
        ...
        zzttVar.m9394e(this.f16812r, this.f16862b);
    }
