...
final class ResamplingAudioProcessor extends BaseAudioProcessor {
    ...
    */
    public void mo6115d(java.nio.ByteBuffer r10) {
        /*
            r9 = this;
            int r0 = r10.position()
            int r1 = r10.limit()
            int r2 = r1 - r0
            com.google.android.exoplayer2.audio.AudioProcessor$AudioFormat r3 = r9.f10357b
            int r3 = r3.f10303c
        ...
        L2d:
            int r2 = r2 * 2
        L2f:
            java.nio.ByteBuffer r2 = r9.m6161k(r2)
            com.google.android.exoplayer2.audio.AudioProcessor$AudioFormat r3 = r9.f10357b
            int r3 = r3.f10303c
            if (r3 == r8) goto Lb0
            if (r3 == r7) goto L8a
        ...
        L8a:
            ...
            float r3 = com.google.android.exoplayer2.util.Util.m7740i(r3, r4, r5)
        ...
        Lc5:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.audio.ResamplingAudioProcessor.mo6115d(java.nio.ByteBuffer):void");
    }
    ...
    public AudioProcessor.AudioFormat mo6157g(AudioProcessor.AudioFormat audioFormat) throws AudioProcessor.UnhandledAudioFormatException {
        ...
        if (i2 == 3 || i2 == 2 || i2 == 268435456 || i2 == 536870912 || i2 == 805306368 || i2 == 4) {
            return i2 != 2 ? new AudioProcessor.AudioFormat(audioFormat.f10301a, audioFormat.f10302b, 2) : AudioProcessor.AudioFormat.f10300e;
        }
