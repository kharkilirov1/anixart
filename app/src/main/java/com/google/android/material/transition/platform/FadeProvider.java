...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    /* renamed from: a */
    public float f19466a = 1.0f;

    /* renamed from: c */
    public static Animator m10610c(final View view, final float f2, final float f3, @FloatRange final float f4, @FloatRange final float f5, final float f6) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.transition.platform.FadeProvider.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(TransitionUtils.m10636d(f2, f3, f4, f5, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
            }
        });
    ...
    public Animator mo10611a(@NonNull ViewGroup viewGroup, @NonNull View view) {
        ...
        return m10610c(view, 0.0f, alpha, 0.0f, this.f19466a, alpha);
    }
    ...
    public Animator mo10612b(@NonNull ViewGroup viewGroup, @NonNull View view) {
        float alpha = view.getAlpha() == 0.0f ? 1.0f : view.getAlpha();
        return m10610c(view, alpha, 0.0f, 0.0f, 1.0f, alpha);
    }
}
