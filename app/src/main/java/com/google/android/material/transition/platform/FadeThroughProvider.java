...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    /* renamed from: c */
    public static Animator m10613c(final View view, final float f2, final float f3, @FloatRange final float f4, @FloatRange final float f5, final float f6) {
    ...
    public Animator mo10611a(@NonNull ViewGroup viewGroup, @NonNull View view) {
        ...
        return m10613c(view, 0.0f, alpha, 0.35f, 1.0f, alpha);
    }
    ...
    public Animator mo10612b(@NonNull ViewGroup viewGroup, @NonNull View view) {
        float alpha = view.getAlpha() == 0.0f ? 1.0f : view.getAlpha();
        return m10613c(view, alpha, 0.0f, 0.0f, 0.35f, alpha);
    }
}
