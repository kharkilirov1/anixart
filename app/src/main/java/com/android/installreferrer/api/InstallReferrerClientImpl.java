...
class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public final class InstallReferrerServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            InstallReferrerCommons.m4862a(InstallReferrerClientImpl.TAG, "Install Referrer service connected.");
            InstallReferrerClientImpl installReferrerClientImpl = InstallReferrerClientImpl.this;
            int i2 = IGetInstallReferrerService.Stub.f15004a;
            if (iBinder == null) {
                proxy = null;
            } else {
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            InstallReferrerCommons.m4863b(InstallReferrerClientImpl.TAG, "Install Referrer service disconnected.");
    ...
    public void endConnection() {
        ...
        if (this.serviceConnection != null) {
            InstallReferrerCommons.m4862a(TAG, "Unbinding from service.");
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        ...
        try {
            return new ReferrerDetails(this.service.mo7829E0(bundle));
        } catch (RemoteException e2) {
            InstallReferrerCommons.m4863b(TAG, "RemoteException getting install referrer information");
            this.clientState = 0;
            throw e2;
        }
    }
    ...
    public void startConnection(InstallReferrerStateListener installReferrerStateListener) {
        ...
        if (isReady()) {
            InstallReferrerCommons.m4862a(TAG, "Service connection is valid. No need to re-initialize.");
            installReferrerStateListener.onInstallReferrerSetupFinished(0);
            return;
        }
        int i2 = this.clientState;
        if (i2 == 1) {
            InstallReferrerCommons.m4863b(TAG, "Client is already in the process of connecting to the service.");
            installReferrerStateListener.onInstallReferrerSetupFinished(3);
            return;
        }
        if (i2 == 3) {
            InstallReferrerCommons.m4863b(TAG, "Client was already closed and can't be reused. Please create another instance.");
            installReferrerStateListener.onInstallReferrerSetupFinished(3);
            return;
        }
        InstallReferrerCommons.m4862a(TAG, "Starting install referrer service setup.");
        ...
        if (queryIntentServices == null || queryIntentServices.isEmpty() || (serviceInfo = queryIntentServices.get(0).serviceInfo) == null) {
            this.clientState = 0;
            InstallReferrerCommons.m4862a(TAG, "Install Referrer service unavailable on device.");
        ...
        if (!SERVICE_PACKAGE_NAME.equals(str) || str2 == null || !isPlayStoreCompatible()) {
            InstallReferrerCommons.m4863b(TAG, "Play Store missing or incompatible. Version 8.3.73 or later required.");
            this.clientState = 0;
            installReferrerStateListener.onInstallReferrerSetupFinished(2);
            return;
        }
        ...
        try {
            if (this.mApplicationContext.bindService(intent2, installReferrerServiceConnection, 1)) {
                InstallReferrerCommons.m4862a(TAG, "Service was bonded successfully.");
                return;
            }
            InstallReferrerCommons.m4863b(TAG, "Connection to service is blocked.");
            this.clientState = 0;
            installReferrerStateListener.onInstallReferrerSetupFinished(1);
        } catch (SecurityException unused) {
            InstallReferrerCommons.m4863b(TAG, "No permission to connect to service.");
            this.clientState = 0;
