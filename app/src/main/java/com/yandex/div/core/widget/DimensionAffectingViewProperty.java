...
@Metadata(m31882bv = {}, m31883d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u00012\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00028\u00000\u0002¨\u0006\u0004"}, m31884d2 = {"Lcom/yandex/div/core/widget/DimensionAffectingViewProperty;", "T", "Lkotlin/properties/ReadWriteProperty;", "Landroid/view/View;", "div_release"}, m31885k = 1, m31886mv = {1, 5, 1})
...
final class DimensionAffectingViewProperty<T> implements ReadWriteProperty<View, T> {
    ...
    public void setValue(View view, KProperty property, Object obj) {
        ...
        Intrinsics.m32179h(thisRef, "thisRef");
        Intrinsics.m32179h(property, "property");
        Function1<T, T> function1 = this.f32966b;
        if (function1 != null && (invoke = function1.invoke(obj)) != null) {
            obj = invoke;
        }
        if (Intrinsics.m32174c(this.f32965a, obj)) {
            return;
        }
        this.f32965a = (T) obj;
