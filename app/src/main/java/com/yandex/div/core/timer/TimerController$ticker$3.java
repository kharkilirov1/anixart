...
public /* synthetic */ class TimerController$ticker$3 extends FunctionReferenceImpl implements Function1<Long, Unit> {
    ...
    public Unit invoke(Long l2) {
        ...
        if (UiThreadHandler.m17397a()) {
            List<DivAction> list = timerController.f31396g;
            if (list != null) {
            ...
            UiThreadHandler.f33904b.post(new Runnable() { // from class: com.yandex.div.core.timer.TimerController$onEnd$$inlined$executeOnMainThread$1
                @Override // java.lang.Runnable
                public final void run() {
                    List<DivAction> list2 = TimerController.this.f31396g;
                    if (list2 == null) {
                        return;
                    }
