...
final class DivSlider$TextStyle$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivSlider$TextStyle$writeToJSON$1();
    }

    public DivSlider$TextStyle$writeToJSON$1() {
        super(1);
    }
