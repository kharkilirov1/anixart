...
final class DivChangeBoundsTransition$writeToJSON$1 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivChangeBoundsTransition$writeToJSON$1();
    }

    public DivChangeBoundsTransition$writeToJSON$1() {
        super(1);
    }
