...
final class DivTextTemplate$RangeTemplate$writeToJSON$2 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivTextTemplate$RangeTemplate$writeToJSON$2();
    }

    public DivTextTemplate$RangeTemplate$writeToJSON$2() {
        super(1);
    }
