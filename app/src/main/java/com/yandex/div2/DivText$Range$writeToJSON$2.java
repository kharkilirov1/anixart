...
final class DivText$Range$writeToJSON$2 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivText$Range$writeToJSON$2();
    }

    public DivText$Range$writeToJSON$2() {
        super(1);
    }
