...
final class DivAccessibilityTemplate$writeToJSON$2 extends Lambda implements Function1<DivAccessibility.Type, Object> {
    static {
        new DivAccessibilityTemplate$writeToJSON$2();
    }
