...
final class DivRadialGradientFixedCenterTemplate$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivRadialGradientFixedCenterTemplate$writeToJSON$1();
    }
