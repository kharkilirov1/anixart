...
final class DivScaleTransitionTemplate$writeToJSON$1 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivScaleTransitionTemplate$writeToJSON$1();
    }

    public DivScaleTransitionTemplate$writeToJSON$1() {
        super(1);
    }
