...
final class DivDimension$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivDimension$writeToJSON$1();
    }

    public DivDimension$writeToJSON$1() {
        super(1);
    }
