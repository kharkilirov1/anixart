...
final class DivContainer$writeToJSON$6 extends Lambda implements Function1<DivContainer.Orientation, String> {
    static {
        new DivContainer$writeToJSON$6();
    }

    public DivContainer$writeToJSON$6() {
        super(1);
    }
