...
final class DivSlideTransition$writeToJSON$2 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivSlideTransition$writeToJSON$2();
    }

    public DivSlideTransition$writeToJSON$2() {
        super(1);
    }
