...
final class DivTextTemplate$writeToJSON$4 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivTextTemplate$writeToJSON$4();
    }

    public DivTextTemplate$writeToJSON$4() {
        super(1);
    }
