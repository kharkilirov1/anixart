...
final class DivWrapContentSize$ConstraintSize$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivWrapContentSize$ConstraintSize$writeToJSON$1();
    }
