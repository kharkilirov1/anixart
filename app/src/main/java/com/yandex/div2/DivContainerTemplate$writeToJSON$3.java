...
final class DivContainerTemplate$writeToJSON$3 extends Lambda implements Function1<DivContentAlignmentHorizontal, String> {
    static {
        new DivContainerTemplate$writeToJSON$3();
    }

    public DivContainerTemplate$writeToJSON$3() {
        super(1);
    }
