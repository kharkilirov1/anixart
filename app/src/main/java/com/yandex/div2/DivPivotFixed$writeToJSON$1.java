...
final class DivPivotFixed$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivPivotFixed$writeToJSON$1();
    }

    public DivPivotFixed$writeToJSON$1() {
        super(1);
    }
