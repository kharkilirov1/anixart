...
final class DivChangeBoundsTransitionTemplate$writeToJSON$1 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivChangeBoundsTransitionTemplate$writeToJSON$1();
    }
