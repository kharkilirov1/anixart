...
final class DivFadeTransitionTemplate$writeToJSON$1 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivFadeTransitionTemplate$writeToJSON$1();
    }

    public DivFadeTransitionTemplate$writeToJSON$1() {
        super(1);
    }
