...
final class DivAnimationTemplate$writeToJSON$1 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivAnimationTemplate$writeToJSON$1();
    }

    public DivAnimationTemplate$writeToJSON$1() {
        super(1);
    }
