...
final class DivRadialGradientRelativeRadiusTemplate$writeToJSON$1 extends Lambda implements Function1<DivRadialGradientRelativeRadius.Value, String> {
    static {
        new DivRadialGradientRelativeRadiusTemplate$writeToJSON$1();
    }
