...
final class DivEdgeInsetsTemplate$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivEdgeInsetsTemplate$writeToJSON$1();
    }

    public DivEdgeInsetsTemplate$writeToJSON$1() {
        super(1);
    }
