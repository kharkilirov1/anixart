...
final class DivPivotFixedTemplate$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivPivotFixedTemplate$writeToJSON$1();
    }

    public DivPivotFixedTemplate$writeToJSON$1() {
        super(1);
    }
