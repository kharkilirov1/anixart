...
final class DivEdgeInsets$writeToJSON$1 extends Lambda implements Function1<DivSizeUnit, String> {
    static {
        new DivEdgeInsets$writeToJSON$1();
    }

    public DivEdgeInsets$writeToJSON$1() {
        super(1);
    }
