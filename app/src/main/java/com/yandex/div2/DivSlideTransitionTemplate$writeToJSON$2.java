...
final class DivSlideTransitionTemplate$writeToJSON$2 extends Lambda implements Function1<DivAnimationInterpolator, String> {
    static {
        new DivSlideTransitionTemplate$writeToJSON$2();
    }

    public DivSlideTransitionTemplate$writeToJSON$2() {
        super(1);
    }
