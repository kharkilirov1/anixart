...
public final class CharTypes {
    ...
    /* renamed from: HB */
    private static final byte[] f8864HB;

    /* renamed from: HC */
    private static final char[] f8865HC;
    ...
    static {
        ...
        f8864HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f8864HB[i2] = (byte) f8865HC[i2];
        }
    ...
    public static int charToHex(int i2) {
        return sHexValues[i2 & KotlinVersion.MAX_COMPONENT_VALUE];
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f8864HB.clone();
    }

    public static char[] copyHexChars() {
        return (char[]) f8865HC.clone();
    }
