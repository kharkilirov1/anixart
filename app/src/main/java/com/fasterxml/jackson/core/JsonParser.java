...
public abstract class JsonParser implements Closeable, Versioned {
    ...
    public void _reportUnsupportedOperation() {
        StringBuilder m24u = C0000a.m24u("Operation not supported by parser of type ");
    ...
    public byte getByteValue() throws IOException {
        ...
        StringBuilder m24u = C0000a.m24u("Numeric value (");
        m24u.append(getText());
        m24u.append(") out of range of Java byte");
    ...
    public short getShortValue() throws IOException {
        ...
        StringBuilder m24u = C0000a.m24u("Numeric value (");
        m24u.append(getText());
        m24u.append(") out of range of Java short");
        throw _constructError(m24u.toString());
    }
    ...
    public void setSchema(FormatSchema formatSchema) {
        StringBuilder m24u = C0000a.m24u("Parser of type ");
        m24u.append(getClass().getName());
