...
public abstract class DatabindContext {
    ...
    public String _colonConcat(String str, String str2) {
        return str2 == null ? str : C0000a.m16m(str, ": ", str2);
    }
    ...
    public <T> T _throwSubtypeClassNotAllowed(JavaType javaType, String str, PolymorphicTypeValidator polymorphicTypeValidator) throws JsonMappingException {
        StringBuilder m24u = C0000a.m24u("Configured `PolymorphicTypeValidator` (of type ");
        m24u.append(ClassUtil.classNameOf(polymorphicTypeValidator));
        m24u.append(") denied resolution");
