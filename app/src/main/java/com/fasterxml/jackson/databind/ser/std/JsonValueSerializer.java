...
public class JsonValueSerializer extends StdSerializer<Object> implements ContextualSerializer {
    ...
    public void serialize(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        try {
            ...
            wrapAndThrow(serializerProvider, e2, obj, this._accessor.getName() + "()");
        }
    }
    ...
    public String toString() {
        StringBuilder m24u = C0000a.m24u("(@JsonValue serializer for method ");
        m24u.append(this._accessor.getDeclaringClass());
        m24u.append("#");
        m24u.append(this._accessor.getName());
        m24u.append(")");
