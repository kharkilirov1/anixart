...
public class BasicBeanDescription extends BeanDescription {
    ...
    public Converter<Object, Object> _createConverter(Object obj) {
        ...
        if (!(obj instanceof Class)) {
            StringBuilder m24u = C0000a.m24u("AnnotationIntrospector returned Converter definition of type ");
            m24u.append(obj.getClass().getName());
            m24u.append("; expected type Converter or Class<Converter> instead");
        ...
        if (!Converter.class.isAssignableFrom(cls)) {
            throw new IllegalStateException(C0576a.m4116o(cls, C0000a.m24u("AnnotationIntrospector returned Class "), "; expected Class<Converter>"));
        }
    ...
    public AnnotatedMember findAnyGetter() throws IllegalArgumentException {
        ...
        StringBuilder m24u = C0000a.m24u("Invalid 'any-getter' annotation on method ");
        m24u.append(anyGetter.getName());
        m24u.append("(): return type is not instance of java.util.Map");
        ...
        for (BeanPropertyDefinition beanPropertyDefinition : _properties()) {
            ...
            if (findReferenceType != null && findReferenceType.isBackReference()) {
                ...
                if (arrayList == null) {
                    ...
                    throw new IllegalArgumentException(C0000a.m16m("Multiple back-reference properties with name '", name, "'"));
                }
    ...
    public Object instantiateBean(boolean z) {
        ...
        try {
            ...
            StringBuilder m24u = C0000a.m24u("Failed to instantiate bean of type ");
            m24u.append(this._classInfo.getAnnotated().getName());
            m24u.append(": (");
            m24u.append(e.getClass().getName());
            m24u.append(") ");
            m24u.append(ClassUtil.exceptionMessage(e));
            throw new IllegalArgumentException(m24u.toString(), e);
        }
    }
