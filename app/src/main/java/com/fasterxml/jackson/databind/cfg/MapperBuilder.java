...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B activateDefaultTyping(PolymorphicTypeValidator polymorphicTypeValidator, ObjectMapper.DefaultTyping defaultTyping, JsonTypeInfo.EnumC0834As enumC0834As) {
        this._mapper.activateDefaultTyping(polymorphicTypeValidator, defaultTyping, enumC0834As);
        return _this();
    }
