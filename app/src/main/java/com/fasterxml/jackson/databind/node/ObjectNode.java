...
public class ObjectNode extends ContainerNode<ObjectNode> {
    ...
    public ObjectNode with(String str) {
        ...
        StringBuilder m28y = C0000a.m28y("Property '", str, "' has value that is not of type ObjectNode (but ");
        m28y.append(jsonNode.getClass().getName());
        m28y.append(")");
        throw new UnsupportedOperationException(m28y.toString());
    }
    ...
    public ArrayNode withArray(String str) {
        ...
        StringBuilder m28y = C0000a.m28y("Property '", str, "' has value that is not of type ArrayNode (but ");
        m28y.append(jsonNode.getClass().getName());
        m28y.append(")");
        throw new UnsupportedOperationException(m28y.toString());
    }
    ...
    public ObjectNode put(String str, Long l2) {
        ...
        if (l2 == null) {
            ...
            numberNode = numberNode(l2.longValue());
        }
        return _put(str, numberNode);
    }
    ...
    public ObjectNode put(String str, Float f2) {
        ...
        if (f2 == null) {
            ...
            numberNode = numberNode(f2.floatValue());
        }
        return _put(str, numberNode);
    }
