...
public abstract class JavaUtilCollectionsDeserializers {
    ...
    public static class JavaUtilCollectionsConverter implements Converter<Object, Object> {
        ...
        private void _checkSingleton(int i2) {
            if (i2 != 1) {
                throw new IllegalArgumentException(C0000a.m8e("Can not deserialize Singleton container from ", i2, " entries"));
            }
        }
    ...
    public static JavaUtilCollectionsConverter converter(int i2, JavaType javaType, Class<?> cls) {
