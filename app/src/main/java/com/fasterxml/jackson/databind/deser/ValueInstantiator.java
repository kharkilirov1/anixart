...
public abstract class ValueInstantiator {
    ...
    public Object createFromLong(DeserializationContext deserializationContext, long j2) throws IOException {
        return deserializationContext.handleMissingInstantiator(getValueClass(), this, null, "no long/Long-argument constructor/factory method to deserialize from Number value (%s)", Long.valueOf(j2));
    }
