...
public class AnnotationIntrospectorPair extends AnnotationIntrospector {
    ...
    public PropertyName findNameForDeserialization(Annotated annotated) {
        ...
        return findNameForDeserialization2 == null ? this._secondary.findNameForDeserialization(annotated) : (findNameForDeserialization2 != PropertyName.USE_DEFAULT || (findNameForDeserialization = this._secondary.findNameForDeserialization(annotated)) == null) ? findNameForDeserialization2 : findNameForDeserialization;
    }
    ...
    public PropertyName findNameForSerialization(Annotated annotated) {
        ...
        return findNameForSerialization2 == null ? this._secondary.findNameForSerialization(annotated) : (findNameForSerialization2 != PropertyName.USE_DEFAULT || (findNameForSerialization = this._secondary.findNameForSerialization(annotated)) == null) ? findNameForSerialization2 : findNameForSerialization;
    }
    ...
    public PropertyName findRootName(AnnotatedClass annotatedClass) {
        ...
        return findRootName2 == null ? this._secondary.findRootName(annotatedClass) : (findRootName2.hasSimpleName() || (findRootName = this._secondary.findRootName(annotatedClass)) == null) ? findRootName2 : findRootName;
    }
    ...
    public PropertyName findWrapperName(Annotated annotated) {
        ...
        return findWrapperName2 == null ? this._secondary.findWrapperName(annotated) : (findWrapperName2 != PropertyName.USE_DEFAULT || (findWrapperName = this._secondary.findWrapperName(annotated)) == null) ? findWrapperName2 : findWrapperName;
    }
