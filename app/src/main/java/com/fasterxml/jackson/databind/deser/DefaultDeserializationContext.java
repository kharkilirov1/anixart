    ...
    public JsonDeserializer<Object> deserializerInstance(Annotated annotated, Object obj) throws JsonMappingException {
        ...
        if (obj instanceof JsonDeserializer) {
            ...
            if (!(obj instanceof Class)) {
                StringBuilder m24u = C0000a.m24u("AnnotationIntrospector returned deserializer definition of type ");
                m24u.append(obj.getClass().getName());
                m24u.append("; expected type JsonDeserializer or Class<JsonDeserializer> instead");
            ...
            if (!JsonDeserializer.class.isAssignableFrom(cls)) {
                throw new IllegalStateException(C0576a.m4116o(cls, C0000a.m24u("AnnotationIntrospector returned Class "), "; expected Class<JsonDeserializer>"));
            }
    ...
    public final KeyDeserializer keyDeserializerInstance(Annotated annotated, Object obj) throws JsonMappingException {
        ...
        if (obj instanceof KeyDeserializer) {
            ...
            if (!KeyDeserializer.class.isAssignableFrom(cls)) {
                throw new IllegalStateException(C0576a.m4116o(cls, C0000a.m24u("AnnotationIntrospector returned Class "), "; expected Class<KeyDeserializer>"));
            }
            HandlerInstantiator handlerInstantiator = this._config.getHandlerInstantiator();
