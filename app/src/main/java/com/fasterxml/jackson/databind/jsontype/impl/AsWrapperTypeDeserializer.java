    ...
    public Object _deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (currentToken == jsonToken) {
            ...
            if (nextToken != jsonToken2) {
                ...
                StringBuilder m24u = C0000a.m24u("need JSON String that contains type id (for subtype of ");
                m24u.append(baseTypeName());
                m24u.append(")");
                deserializationContext.reportWrongTokenException(baseType, jsonToken2, m24u.toString(), new Object[0]);
            }
        } else if (currentToken != JsonToken.FIELD_NAME) {
            JavaType baseType2 = baseType();
            StringBuilder m24u2 = C0000a.m24u("need JSON Object to contain As.WRAPPER_OBJECT type information for class ");
            m24u2.append(baseTypeName());
            deserializationContext.reportWrongTokenException(baseType2, jsonToken, m24u2.toString(), new Object[0]);
        }
