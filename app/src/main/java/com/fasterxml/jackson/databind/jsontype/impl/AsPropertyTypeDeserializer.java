...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    public final JsonTypeInfo.EnumC0834As _inclusion;
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2) {
        this(javaType, typeIdResolver, str, z, javaType2, JsonTypeInfo.EnumC0834As.PROPERTY);
    }
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.EnumC0834As enumC0834As) {
        super(javaType, typeIdResolver, str, z, javaType2);
        this._inclusion = enumC0834As;
    }
