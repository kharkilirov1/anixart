...
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        public Object _deserializeFromEmptyString() throws IOException {
            int i2 = this._kind;
            return i2 == 3 ? URI.create("") : i2 == 8 ? Locale.ROOT : i2 == 13 ? new StringBuilder() : super._deserializeFromEmptyString();
        }
        ...
        if (valueAsString.length() != 0) {
            ...
            if (trim.length() != 0) {
                try {
                    ...
                    JsonMappingException weirdStringException = deserializationContext.weirdStringException(trim, this._valueClass, message != null ? C0000a.m16m("not a valid textual representation", ", problem: ", message) : "not a valid textual representation");
