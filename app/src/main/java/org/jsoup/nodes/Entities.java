...
public class Entities {
    ...
    /* renamed from: a */
    public static final char[] f68987a = {',', ';'};

    /* renamed from: b */
    public static final HashMap<String, String> f68988b = new HashMap<>();
    ...
    public enum EscapeMode {
        ...
        /* renamed from: e */
        public String[] f69001e;

        EscapeMode(String str, int i2) {
            int i3;
            char[] cArr = Entities.f68987a;
            this.f68998b = new String[i2];
            this.f68999c = new int[i2];
            this.f69000d = new int[i2];
            this.f69001e = new String[i2];
            CharacterReader characterReader = new CharacterReader(new StringReader(str), str.length());
            int i4 = 0;
            while (!characterReader.m34820p()) {
                try {
                    String m34814j = characterReader.m34814j('=');
                    characterReader.m34806a();
                    int parseInt = Integer.parseInt(characterReader.m34815k(Entities.f68987a), 36);
                    char m34818n = characterReader.m34818n();
                    characterReader.m34806a();
                    if (m34818n == ',') {
                        i3 = Integer.parseInt(characterReader.m34814j(';'), 36);
                        characterReader.m34806a();
                    } else {
                        i3 = -1;
                    }
                    int parseInt2 = Integer.parseInt(characterReader.m34814j('&'), 36);
                    characterReader.m34806a();
                    this.f68998b[i4] = m34814j;
                    this.f68999c[i4] = parseInt;
                    this.f69000d[parseInt2] = parseInt;
                    this.f69001e[parseInt2] = m34814j;
                    if (i3 != -1) {
                        Entities.f68988b.put(m34814j, new String(new int[]{parseInt, i3}, 0, 2));
                    }
                    i4++;
                } finally {
                    characterReader.m34808d();
                }
            }
            Validate.m34691d(i4 == i2, "Unexpected count of entities loaded");
        }

        /* renamed from: a */
        public int m34777a(String str) {
            int binarySearch = Arrays.binarySearch(this.f68998b, str);
            if (binarySearch >= 0) {
                return this.f68999c[binarySearch];
            }
            return -1;
        }
    }
    ...
    /* renamed from: a */
    public static void m34775a(Appendable appendable, EscapeMode escapeMode, int i2) throws IOException {
        String str;
        int binarySearch = Arrays.binarySearch(escapeMode.f69000d, i2);
        if (binarySearch >= 0) {
            String[] strArr = escapeMode.f69001e;
            if (binarySearch < strArr.length - 1) {
                int i3 = binarySearch + 1;
                if (escapeMode.f69000d[i3] == i2) {
                    str = strArr[i3];
                }
            }
    ...
    /* renamed from: b */
    public static void m34776b(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z, boolean z2, boolean z3, boolean z4) throws IOException {
        EscapeMode escapeMode = outputSettings.f68964b;
        CharsetEncoder charsetEncoder = outputSettings.f68966d.get();
        if (charsetEncoder == null) {
            charsetEncoder = outputSettings.m34746b();
        }
        CoreCharset coreCharset = outputSettings.f68967e;
        ...
        while (i2 < length) {
            ...
            boolean z8 = true;
            if (z2) {
                if (StringUtil.m34703e(codePointAt)) {
                    if ((!z3 || z6) && !z7) {
                        if (z4) {
                            z5 = true;
                        } else {
            ...
            if (codePointAt < 65536) {
                ...
                if (c2 == '\t' || c2 == '\n' || c2 == '\r') {
                        ...
                        if (c2 != '>') {
                            if (c2 != 160) {
                                if (c2 >= ' ') {
                                    ...
                                    if (ordinal != 0) {
                                        if (ordinal != 1) {
                                            z8 = charsetEncoder.canEncode(c2);
                                        }
                                    } else if (c2 >= 128) {
                                        z8 = false;
                                    }
                                ...
                                m34775a(appendable, escapeMode, codePointAt);
                    ...
                    } else if (!z || escapeMode == EscapeMode.xhtml || outputSettings.f68971i == Document.OutputSettings.Syntax.xml) {
                        appendable.append("&lt;");
                    } else {
                        appendable.append(c2);
                    }
