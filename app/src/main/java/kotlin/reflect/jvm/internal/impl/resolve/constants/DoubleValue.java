...
public final class DoubleValue extends ConstantValue<Double> {
    ...
    public KotlinType mo33521a(ModuleDescriptor module) {
        ...
        SimpleType m32412w = mo32547n.m32412w(PrimitiveType.DOUBLE);
        Intrinsics.m32175d(m32412w, "module.builtIns.doubleType");
        return m32412w;
    }
    ...
    public String toString() {
        return ((Number) this.f65921a).doubleValue() + ".toDouble()";
    }
}
