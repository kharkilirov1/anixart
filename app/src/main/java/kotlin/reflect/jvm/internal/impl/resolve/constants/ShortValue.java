...
public final class ShortValue extends IntegerValueConstant<Short> {
    ...
    public KotlinType mo33521a(ModuleDescriptor module) {
        ...
        SimpleType m32412w = mo32547n.m32412w(PrimitiveType.SHORT);
        Intrinsics.m32175d(m32412w, "module.builtIns.shortType");
        return m32412w;
    }
    ...
    public String toString() {
        return ((int) ((Number) this.f65921a).shortValue()) + ".toShort()";
    }
}
