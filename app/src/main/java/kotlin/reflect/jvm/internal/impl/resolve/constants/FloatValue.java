...
public final class FloatValue extends ConstantValue<Float> {
    ...
    public KotlinType mo33521a(ModuleDescriptor module) {
        ...
        SimpleType m32412w = mo32547n.m32412w(PrimitiveType.FLOAT);
        Intrinsics.m32175d(m32412w, "module.builtIns.floatType");
        return m32412w;
    }
    ...
    public String toString() {
        return ((Number) this.f65921a).floatValue() + ".toFloat()";
    }
}
