...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public DialogFragment() {
        ...
        this.mObserver = new Observer<LifecycleOwner>() { // from class: androidx.fragment.app.DialogFragment.4
            ...
            @SuppressLint
            /* renamed from: a */
            public void mo2959a(LifecycleOwner lifecycleOwner) {
    ...
    private void dismissInternal(boolean z, boolean z2, boolean z3) {
        ...
        if (this.mBackStackId >= 0) {
            if (z3) {
                ...
                parentFragmentManager.m3019a0(null, i2, 1);
            } else {
                getParentFragmentManager().m3016Y(this.mBackStackId, 1, z);
            }
            this.mBackStackId = -1;
            return;
        }
        ...
        backStackRecord.mo2943m(this);
        if (z3) {
            backStackRecord.mo2938g();
        } else if (z) {
            backStackRecord.mo2937f();
        } else {
            backStackRecord.mo2936e();
        }
    }
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public View mo2960b(int i2) {
                return createFragmentContainer.mo2961c() ? createFragmentContainer.mo2960b(i2) : DialogFragment.this.onFindViewById(i2);
            }

            @Override // androidx.fragment.app.FragmentContainer
            /* renamed from: c */
            public boolean mo2961c() {
                return createFragmentContainer.mo2961c() || DialogFragment.this.onHasView();
            }
        };
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        getViewLifecycleOwnerLiveData().m3212g(this.mObserver);
        if (this.mShownByMe) {
            return;
        }
    ...
    public void onDetach() {
        ...
        getViewLifecycleOwnerLiveData().mo3215k(this.mObserver);
    }
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            decorView.setTag(C2507R.id.view_tree_lifecycle_owner, this);
            decorView.setTag(C2507R.id.view_tree_view_model_store_owner, this);
            ViewTreeSavedStateRegistryOwner.m4138a(decorView, this);
        }
    }
    ...
    public void show(@NonNull FragmentManager fragmentManager, @Nullable String str) {
        ...
        backStackRecord.f4441p = true;
        backStackRecord.mo2941k(0, this, str, 1);
        backStackRecord.mo2936e();
    }
    ...
    public int show(@NonNull FragmentTransaction fragmentTransaction, @Nullable String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        fragmentTransaction.mo2941k(0, this, str, 1);
        this.mViewDestroyed = false;
        int mo2936e = fragmentTransaction.mo2936e();
        this.mBackStackId = mo2936e;
        return mo2936e;
    }
