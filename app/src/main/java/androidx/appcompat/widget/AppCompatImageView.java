...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView {
    ...
    /* renamed from: b */
    public final AppCompatBackgroundHelper f1189b;

    /* renamed from: c */
    public final AppCompatImageHelper f1190c;
    ...
    public void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1189b;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.m714a();
        }
        AppCompatImageHelper appCompatImageHelper = this.f1190c;
    ...
    public boolean hasOverlappingRendering() {
        return ((this.f1190c.f1185a.getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(@Nullable Drawable drawable) {
        AppCompatImageHelper appCompatImageHelper = this.f1190c;
        if (appCompatImageHelper != null && drawable != null && !this.f1191d) {
            appCompatImageHelper.f1188d = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        AppCompatImageHelper appCompatImageHelper2 = this.f1190c;
        if (appCompatImageHelper2 != null) {
            appCompatImageHelper2.m747a();
            if (this.f1191d) {
                return;
            }
            AppCompatImageHelper appCompatImageHelper3 = this.f1190c;
    ...
    public AppCompatImageView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.f1189b = appCompatBackgroundHelper;
        appCompatBackgroundHelper.m717d(attributeSet, i2);
        AppCompatImageHelper appCompatImageHelper = new AppCompatImageHelper(this);
        this.f1190c = appCompatImageHelper;
