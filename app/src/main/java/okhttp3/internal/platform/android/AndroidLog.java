...
public final class AndroidLog {
    ...
    static {
        ...
        knownLoggers = MapsKt.m32068m(linkedHashMap);
    }
    ...
    private final void enableLogging(String logger, String tag) {
        ...
        if (configuredLoggers.add(logger2)) {
            Intrinsics.m32178g(logger2, "logger");
    ...
    private final String loggerTag(String loggerName) {
        ...
        return str != null ? str : StringsKt.m33907g0(loggerName, 23);
    }
    ...
    public final void androidLog$okhttp(@NotNull String loggerName, int logLevel, @NotNull String message, @Nullable Throwable t) {
        ...
        if (Log.isLoggable(loggerTag, logLevel)) {
            if (t != null) {
                ...
                m27x.append(Log.getStackTraceString(t));
                message = m27x.toString();
            }
            int i2 = 0;
            ...
            while (i2 < length) {
                ...
                while (true) {
                    min = Math.min(m33877C, i2 + MAX_LOG_LENGTH);
