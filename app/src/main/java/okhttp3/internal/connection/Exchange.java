...
public final class Exchange {
    ...
    public final class RequestBodySink extends ForwardingSink {
        ...
        public void write(@NotNull Buffer source, long byteCount) throws IOException {
            ...
            m24u.append(this.contentLength);
            m24u.append(" bytes but received ");
            m24u.append(this.bytesReceived + byteCount);
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !Intrinsics.m32174c(this.finder.getAddress().url().host(), this.connection.getRoute().address().url().host());
    }
    ...
    public final ResponseBody openResponseBody(@NotNull Response response) throws IOException {
        ...
        try {
            ...
            return new RealResponseBody(header$default, reportedContentLength, Okio.m34602d(new ResponseBodySource(this, this.codec.openResponseBodySource(response), reportedContentLength)));
        } catch (IOException e2) {
            this.eventListener.responseFailed(this.call, e2);
            trackFailure(e2);
            throw e2;
