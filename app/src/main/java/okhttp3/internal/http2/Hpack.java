...
@Metadata(m31882bv = {1, 0, 3}, m31883d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\t\bÆ\u0002\u0018\u00002\u00020\u0001:\u0002\u0018\u0019B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0015\u001a\u00020\u00052\u0006\u0010\u0016\u001a\u00020\u0005J\u0014\u0010\u0017\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004H\u0002R\u001d\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u000e\u0010\t\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u0019\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00110\u0010¢\u0006\n\n\u0002\u0010\u0014\u001a\u0004\b\u0012\u0010\u0013¨\u0006\u001a"}, m31884d2 = {"Lokhttp3/internal/http2/Hpack;", "", "()V", "NAME_TO_FIRST_INDEX", "", "Lokio/ByteString;", "", "getNAME_TO_FIRST_INDEX", "()Ljava/util/Map;", "PREFIX_4_BITS", "PREFIX_5_BITS", "PREFIX_6_BITS", "PREFIX_7_BITS", "SETTINGS_HEADER_TABLE_SIZE", "SETTINGS_HEADER_TABLE_SIZE_LIMIT", "STATIC_HEADER_TABLE", "", "Lokhttp3/internal/http2/Header;", "getSTATIC_HEADER_TABLE", "()[Lokhttp3/internal/http2/Header;", "[Lokhttp3/internal/http2/Header;", "checkLowercase", "name", "nameToFirstIndex", "Reader", "Writer", "okhttp"}, m31885k = 1, m31886mv = {1, 4, 0})
...
public final class Hpack {
    ...
    private final Map<ByteString, Integer> nameToFirstIndex() {
        ...
        Intrinsics.m32178g(unmodifiableMap, "Collections.unmodifiableMap(result)");
    ...
    public static final class Reader {
        ...
        public Reader(@NotNull Source source, int i2, int i3) {
            ...
            this.source = Okio.m34602d(source);
        ...
        private final void clearDynamicTable() {
            ArraysKt.m31974x(this.dynamicTable, null, 0, 0, 6, null);
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> m32027j0 = CollectionsKt.m32027j0(this.headerList);
        ...
        public final ByteString readByteString() throws IOException {
            ...
            if (!z) {
                return this.source.mo34518G(readInt);
            }
            ...
            while (!this.source.mo34529V()) {
                ...
                if ((and & 128) == 128) {
                    ...
                    if (readInt < 0 || readInt > this.headerTableSizeSetting) {
                        StringBuilder m24u = C0000a.m24u("Invalid dynamic table size update ");
                        m24u.append(this.maxDynamicTableByteCount);
                        throw new IOException(m24u.toString());
                    }
    ...
    public static final class Writer {
        ...
        public final void writeByteString(@NotNull ByteString data) throws IOException {
            ...
            if (this.useCompression) {
                ...
                if (huffman.encodedLength(data) < data.mo34576d()) {
                    Buffer buffer = new Buffer();
                    huffman.encode(data, buffer);
                    ByteString mo34515B0 = buffer.mo34515B0();
                    writeInt(mo34515B0.mo34576d(), 127, 128);
                    this.out.m34566v(mo34515B0);
                    return;
                }
            }
            writeInt(data.mo34576d(), 127, 0);
            this.out.m34566v(data);
        }
        ...
        */
        ...
        public final void writeInt(int value, int prefixMask, int bits) {
            if (value < prefixMask) {
                this.out.m34524Q(value | bits);
                return;
            }
            this.out.m34524Q(bits | prefixMask);
            int i2 = value - prefixMask;
            while (i2 >= 128) {
                this.out.m34524Q(128 | (i2 & 127));
                i2 >>>= 7;
            }
            this.out.m34524Q(i2);
        }
