...
@Metadata(m31882bv = {1, 0, 3}, m31883d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\bÆ\u0002\u0018\u00002\u00020\u0001:\u0001\u001aB\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\fH\u0002J\u001e\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0015J\u0016\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u00172\u0006\u0010\u0014\u001a\u00020\u0015J\u000e\u0010\u0018\u001a\u00020\f2\u0006\u0010\u0019\u001a\u00020\u0017R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001b"}, m31884d2 = {"Lokhttp3/internal/http2/Huffman;", "", "()V", "CODES", "", "CODE_BIT_COUNTS", "", "root", "Lokhttp3/internal/http2/Huffman$Node;", "addCode", "", "symbol", "", "code", "codeBitCount", "decode", "source", "Lokio/BufferedSource;", "byteCount", "", "sink", "Lokio/BufferedSink;", "encode", "Lokio/ByteString;", "encodedLength", "bytes", "Node", "okhttp"}, m31885k = 1, m31886mv = {1, 4, 0})
...
public final class Huffman {
    ...
    private final void addCode(int symbol, int code, int codeBitCount) {
        ...
        while (codeBitCount > 8) {
            codeBitCount -= 8;
            int i2 = (code >>> codeBitCount) & KotlinVersion.MAX_COMPONENT_VALUE;
            Node[] children = node2.getChildren();
            Intrinsics.m32176e(children);
        ...
        int i4 = (code << i3) & KotlinVersion.MAX_COMPONENT_VALUE;
        Node[] children2 = node2.getChildren();
        Intrinsics.m32176e(children2);
        ArraysKt.m31973w(children2, node, i4, (1 << i3) + i4);
    }
    ...
    public final void decode(@NotNull BufferedSource source, long byteCount, @NotNull BufferedSink sink) {
        ...
        for (long j2 = 0; j2 < byteCount; j2++) {
            i2 = (i2 << 8) | Util.and(source.readByte(), KotlinVersion.MAX_COMPONENT_VALUE);
            i3 += 8;
            while (i3 >= 8) {
                int i4 = i3 - 8;
        ...
        while (i3 > 0) {
            ...
            Intrinsics.m32176e(children2);
            Node node2 = children2[i6];
            Intrinsics.m32176e(node2);
    ...
    public final void encode(@NotNull ByteString source, @NotNull BufferedSink sink) throws IOException {
        ...
        for (int i3 = 0; i3 < mo34576d; i3++) {
            int and = Util.and(source.mo34579h(i3), KotlinVersion.MAX_COMPONENT_VALUE);
            int i4 = CODES[and];
    ...
    public final int encodedLength(@NotNull ByteString bytes) {
        ...
        for (int i2 = 0; i2 < bytes.mo34576d(); i2++) {
            j2 += CODE_BIT_COUNTS[Util.and(bytes.mo34579h(i2), KotlinVersion.MAX_COMPONENT_VALUE)];
        }
        return (int) ((j2 + 7) >> 3);
    }

    /* compiled from: Huffman.kt */
    @Metadata(m31882bv = {1, 0, 3}, m31883d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\b\b\b\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0016¢\u0006\u0002\u0010\u0002B\u0017\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0002\u0010\u0006R\u001d\u0010\u0007\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\u0000\u0018\u00010\b¢\u0006\n\n\u0002\u0010\u000b\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0011\u0010\u000e\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\r¨\u0006\u0010"}, m31884d2 = {"Lokhttp3/internal/http2/Huffman$Node;", "", "()V", "symbol", "", "bits", "(II)V", "children", "", "getChildren", "()[Lokhttp3/internal/http2/Huffman$Node;", "[Lokhttp3/internal/http2/Huffman$Node;", "getSymbol", "()I", "terminalBitCount", "getTerminalBitCount", "okhttp"}, m31885k = 1, m31886mv = {1, 4, 0})
