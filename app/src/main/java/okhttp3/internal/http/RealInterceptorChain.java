    ...
    public Response proceed(@NotNull Request request) throws IOException {
        ...
        if (exchange != null) {
            if (!exchange.getFinder().sameHostAndPort(request.url())) {
                StringBuilder m24u = C0000a.m24u("network interceptor ");
                m24u.append(this.interceptors.get(this.index - 1));
                m24u.append(" must retain the same host and port");
                throw new IllegalStateException(m24u.toString().toString());
            }
            if (!(this.calls == 1)) {
                StringBuilder m24u2 = C0000a.m24u("network interceptor ");
                m24u2.append(this.interceptors.get(this.index - 1));
                m24u2.append(" must call proceed() exactly once");
