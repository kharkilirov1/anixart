...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert) {
        if (!Intrinsics.m32174c(toVerify.getIssuerDN(), signingCert.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        Intrinsics.m32178g(removeFirst, "queue.removeFirst()");
        ...
        for (int i2 = 0; i2 < 9; i2++) {
            ...
            if (findByIssuerAndSignature == null) {
                ...
                Intrinsics.m32178g(it, "queue.iterator()");
                while (it.hasNext()) {
                    Object next = it.next();
            ...
            if (arrayList.size() > 1 || (!Intrinsics.m32174c(x509Certificate, findByIssuerAndSignature))) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && Intrinsics.m32174c(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex);
    }
