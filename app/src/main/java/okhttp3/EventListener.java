...
public abstract class EventListener {
    ...
    /* compiled from: EventListener.kt */
    @Metadata(m31882bv = {1, 0, 3}, m31883d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m31884d2 = {"Lokhttp3/EventListener$Factory;", "", "create", "Lokhttp3/EventListener;", "call", "Lokhttp3/Call;", "okhttp"}, m31885k = 1, m31886mv = {1, 4, 0})
    ...
    public void connectEnd(@NotNull Call call, @NotNull InetSocketAddress inetSocketAddress, @NotNull Proxy proxy, @Nullable Protocol protocol) {
        Intrinsics.m32179h(call, "call");
        Intrinsics.m32179h(inetSocketAddress, "inetSocketAddress");
    ...
    public void dnsEnd(@NotNull Call call, @NotNull String domainName, @NotNull List<InetAddress> inetAddressList) {
        Intrinsics.m32179h(call, "call");
        Intrinsics.m32179h(domainName, "domainName");
        Intrinsics.m32179h(inetAddressList, "inetAddressList");
    }
    ...
    public void proxySelectEnd(@NotNull Call call, @NotNull HttpUrl url, @NotNull List<Proxy> proxies) {
        ...
        Intrinsics.m32179h(proxies, "proxies");
    }
