...
public final class Route {
    ...
    public boolean equals(@Nullable Object other) {
        if (other instanceof Route) {
            ...
            if (Intrinsics.m32174c(route.address, this.address) && Intrinsics.m32174c(route.proxy, this.proxy) && Intrinsics.m32174c(route.socketAddress, this.socketAddress)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        StringBuilder m24u = C0000a.m24u("Route{");
        m24u.append(this.socketAddress);
        m24u.append('}');
