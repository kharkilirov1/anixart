...
@Metadata(m31882bv = {1, 0, 3}, m31883d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, m31884d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, m31885k = 1, m31886mv = {1, 4, 0})
...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String javaName) {
            ...
            if (!StringsKt.m33898X(javaName, "SSL_", false, 2, null)) {
                return javaName;
            }
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@NotNull String a2, @NotNull String b) {
                ...
                for (int i2 = 4; i2 < min; i2++) {
                    ...
                    if (charAt != charAt2) {
                        return Intrinsics.m32181j(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", C4632R.styleable.AppCompatTheme_textAppearanceListItem);
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", C4632R.styleable.AppCompatTheme_textAppearancePopupMenuHeader);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", C4632R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle);
        TLS_DH_anon_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", C4632R.styleable.AppCompatTheme_textAppearanceSearchResultTitle);
        TLS_DH_anon_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DH_anon_WITH_AES_256_CBC_SHA256", C4632R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu);
